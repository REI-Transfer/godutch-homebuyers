...
export const metadata = {
  title: "How to Spot a Real Local Home Buyer From a Tire-Kicker | GoDutch Homebuyers",
  description:
    "A straightforward 5-minute checklist for sizing up any cash home buyer in the Houston area before you share details or sign anything.",
}
...
export default function Page() {
  ...
  return (
    <ArticleShell
      title="How to Spot a Real Local Home Buyer From a Tire-Kicker in Roughly 5 Minutes"
      dek="A straightforward checklist for sizing up any cash buyer and keeping yourself safe before you share anything or sign a thing."
    ...
    >
      ...
      <P>
        ...
        in {area} has bought houses near you, and they can tell
        you about it. Ask which neighborhoods they have closed in lately. Ask how long they have been
      ...
      <P>
        ...
        a single past seller, or anything you can verify on your own. If their entire history lives
        only in their own mouth, that is not history. That is a sales pitch.
      </P>
      ...
      <P>
        ...
        buyer has the funds standing ready, and they can show you. Ask them flat out: can you prove
        the money is there before we take this any further?
      </P>
      <P>
        Green flag: they say yes without a flinch and offer to show you proof of funds. They do not
      ...
      <P>
        ...
        or an investor first. That last one is the giant tell. A so-called buyer who has to go shop
        your house to someone else is not the buyer at all. They are a middleman hoping to lock you up
      ...
      <P>
        ...
        shape yours is in, what they expect to sink into it. It does not have to be complicated. It
        just has to add up.
      </P>
      <P>
        Green flag: they break it down in plain English and stay patient as you ask follow-up
        questions. You hang up understanding the number, even if you still want to mull it over.
      </P>
      <P>
        ...
        who shows the math up front has far less room to pull that stunt on you later. So make them
        show their work.
      </P>
