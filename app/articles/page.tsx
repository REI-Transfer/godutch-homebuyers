...
export const metadata = {
  title: "Articles for Homeowners | GoDutch Homebuyers",
  description:
    "Straight, plain-English reads for homeowners weighing a sale. What unfolds after you ask for an offer, the real story on lowball offers, how to size up a buyer, and cash compared to listing.",
}
