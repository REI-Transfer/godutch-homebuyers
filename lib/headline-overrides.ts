 ...
 *   curl -sL "https://offer.godutchhomebuyers.com/v2?utm_content=A1-CashRush-PASv1-Houston" | grep "<h1"
 */
...
export const HEADLINE_OVERRIDES: HeadlineOverride[] = [
  ...
  {
    match: /^A1-CashRush-/i,
    h1: "Lock In Your Cash Offer Before The Texas Market Cools",
    sub: "Houston homeowners 55+ are getting cash in 24 hours. Same price at closing.",
  },
  ...
  // A4 — 55EquityRecord
  {
    ...
    h1: "Sitting On Record Equity? See What Your Houston Home Is Actually Worth.",
    sub: "Most Houston owners 55+ don't know. Free cash offer in 24 hours.",
  },

  // A5 — SalesFallApart
  {
    match: /^A5-SalesFallApart-/i,
    h1: "1 In 4 Texas Home Sales Fall Apart. Ours Don't.",
    sub: "Houston sellers 55+ are skipping the listing process. 14-day cash close.",
  },

  // A6 — VacantHouse
  {
    match: /^A6-VacantHouse-/i,
    h1: "Vacant House In Houston? We'll Buy It In 14 Days.",
  ...
  // qualifiers. Pulls long-built, long-owned Houston homes into cash close.
  // ====================================================================

  // C1 — YearBuilt (Pre-2014 Houston homes qualifier)
  {
    match: /^C1-YearBuilt-/i,
    h1: "Pre-2014 Houston Home? See What It's Actually Worth.",
    sub: "Long-built Houston homes are sitting on record equity. 14-day cash close, no repairs.",
  },

  // C2 — YearsOwned (long-term ownership qualifier)
  {
    match: /^C2-YearsOwned-/i,
    h1: "Owned Your Houston Home 10+ Years? See Your Number Today.",
    sub: "Long-term Texas owners are sitting on the strongest equity in years. As-is, 14-day cash close.",
  },
  ...
  // D2 — AgentVsCash (60-day listing vs 14-day cash poll)
  {
    ...
    sub: "Most Houston owners 45+ are skipping the listing. Same price at closing, no commissions.",
  },
]
...
export const DEFAULT_HEADLINE = {
  h1: "Sell Your Houston House For Cash. In 24 Hours.",
  sub: "Fair cash offers, no fees, no commissions. Local Houston team.",
}
